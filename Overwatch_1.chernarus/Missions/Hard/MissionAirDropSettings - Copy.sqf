_DropCrateList 	= ["Misc_cargo_cont_net1","USVehicleBox","RUVehicleBox","Misc_cargo_cont_tiny","Misc_cargo_cont_small2","Misc_cargo_cont_small_EP1"];

_CrateList 		= [	"TKSpecialWeapons_EP1","TKBasicWeapons_EP1","TKBasicAmmunitionBox_EP1","SpecialWeaponsBox","RUSpecialWeaponsBox","RUBasicWeaponsBox",
						"USVehicleBox","RUVehicleBox","USSpecialWeaponsBox","USSpecialWeapons_EP1","vil_RUammoBoxBasic2000s","vil_RUweaponBoxSupport2000s",
						"vil_US_weaponsboxnew","vil_US_weaponsboxold","vil_USMC_weaponsboxnew","RHm14box","RHpistammobox","vil_mix_weaponsBox","vil_BW_weaponsBox",
						"vil_EU_weaponsBox","vil_MiddleEastweaponBox","vil_RUweaponBoxSpeznas"];

_HeliList		 	= ["CH_47F_EP1"];//"MV22_DZ",

_StartPosition	= [[1500,860,300],[4500,860,300],[8000,860,300],[13500,860,300],[1000,7360,300]];				
...
_miscItems3 		= ["ItemToolbox","ItemMatchbox","ItemHatchet","ItemCompass","ItemMachete","ItemRadio","Laserdesignator","ItemEtool"];

_miscItems4 		= ["equip_wood_pallet","ItemWire","PartWheel","equip_metal_sheet","PartGeneric","ItemTankTrap","PartFueltank","ItemJerrycan","PartEngine","ItemSandbag","equip_scrapelectronics","equip_crate","ItemCamoNet",
