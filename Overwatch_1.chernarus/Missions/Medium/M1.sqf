...
[nil,nil,rTitleText,"A military weapons cache has been spotted by bandits, they will arrive to take it over any minute! \nCheck your map for the location!", "PLAIN DOWN",15] call RE;

diag_log format ["AI Missions, medium event started, M1, Bandits have discovered a military weapons cache"];
...
_crateSmall = createVehicle [_crateSmallSelect,_coords,[], 0, "CAN_COLLIDE"];//Crate
...
[SAR_marker_M11,1,0,2,"patrol",false,900] call SAR_AI;

sleep 60;

[nil,nil,rTitleText,"Bandits have arrived at the military weapons cache and attacking all of the soldiers!", "PLAIN DOWN",15] call RE;

[SAR_marker_M12,3,1,2,"patrol",false,900] call SAR_AI;
[SAR_marker_M12,3,0,2,"patrol",false,900] call SAR_AI;

//SAR_marker, AI type: 1=mil 2=surv 3=ban, Vehicle, Crew=lead/snip/sold, Respawn?, Time to respawn
[SAR_marker_M2, 3, ["Offroad_DSHKM_TK_GUE_EP1"], [[1,0,2]], false, 300] call SAR_AI_land;//Bandit

waitUntil{{isPlayer _x && _x distance _crateSmall < 8  } count playableunits > 0}; 

[nil,nil,rTitleText,"The military weapons cache is under survivor control!  \nMission objects will delete in 5 minutes. Crates will delete in 20 minutes!", "PLAIN DOWN",15] call RE;
