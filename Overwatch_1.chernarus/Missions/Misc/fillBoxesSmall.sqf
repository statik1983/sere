//AI Missions Small Weapons Box
private["_miscItem11","_miscItem22","_miscItems1","_miscItems2","_magazine","_weapon","_crateSmall","_allWeapons"];
_crateSmall = _this select 0;
 
clearWeaponCargoGlobal _crateSmall;
clearMagazineCargoGlobal _crateSmall;
...
_miscItems2 = ["Binocular","Binocular_Vector","NVGoggles","ItemCompass","ItemMachete","ItemRadio","Laserdesignator","ItemGps","ItemWatch","ItemKnife","ItemMatchbox","ItemEtool"];
	...
	for "_x" from 0 to 2 do {
		...
		if (_weapon !="") then
		{
			...
			_crateSmall addWeaponCargoGlobal [_weapon, 1];			
			_crateSmall addMagazineCargoGlobal [_magazine, 4];
		};
	};
	// Random 2 items, 3 of each
	for "_x" from 0 to 1 do {
		_miscItem11 = _miscItems1 call BIS_fnc_selectRandom;
		_crateSmall addmagazineCargoGlobal [_miscItem11, 3];
	};	
	// Random 1 items, 1 of each
		for "_x" from 0 to 0 do {
		_miscItem22 = _miscItems2 call BIS_fnc_selectRandom;
		_crateSmall addWeaponCargoGlobal [_miscItem22, 1];
	};