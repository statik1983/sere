...
SAR_AI_custom					= compile preprocessFileLineNumbers "addons\SARGE\SAR_setup_AI_custom.sqf";
...
//[] execVM "addons\SARGE\SAR_config.sqf";
//
...
publicvariable "SAR_DETECT_HOSTILE_ZOMBIE";
