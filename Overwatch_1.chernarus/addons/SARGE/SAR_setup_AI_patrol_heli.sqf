...
_heli setVariable ["AISpawned",true,true];
_heli engineon true; 
...
//Distinguish AI
		_man2heli setVariable ["Sarge",1,true];
...
//Distinguish AI
		_man3heli setVariable ["Sarge",1,true];
