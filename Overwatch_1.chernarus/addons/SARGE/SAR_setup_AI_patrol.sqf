...
[nil,_leader,rADDACTION,"Give me a blood transfusion!", "addons\SARGE\SAR_interact.sqf","",3,true,true,"",_cond] call RE;
...
//Register to booby traps
//_null = [_leader] execVM "dayz_code\external\dy_work\player_bomb.sqf";
//Distinguish AI
...
for "_i" from 0 to (_snipers - 1) do
{
	...
	_this setVariable ["Sarge",1,true];
		//Register to booby traps
//_null = [_this] execVM "dayz_code\external\dy_work\player_bomb.sqf";

[nil,_this,rADDACTION,"****THIS IS A TEST ACTION NO CONDITIONS****", "addons\SARGE\SAR_interact.sqf","",3,true,true,"",""] call RE;
};
